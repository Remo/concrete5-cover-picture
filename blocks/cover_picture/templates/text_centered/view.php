...
<div id="cover-picture-<?php echo $bID?>" class="cover-picture cover-picture-text-centered" style="width: <?php echo $width?>px; height: <?php echo $height?>px; overflow: hidden;">
